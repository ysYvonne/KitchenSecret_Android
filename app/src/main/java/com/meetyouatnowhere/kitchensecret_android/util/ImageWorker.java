...
import com.meetyouatnowhere.kitchensecret_android.BuildConfig;
...
public abstract class ImageWorker {
	...
	private void setImageBitmap(ImageView imageView, Bitmap bitmap) {
		if (mFadeInBitmap) {
			...
			// bitmap
			final TransitionDrawable td = new TransitionDrawable(new Drawable[] { new ColorDrawable(imageView.getContext().getResources().getColor(android.R.color.transparent)),
