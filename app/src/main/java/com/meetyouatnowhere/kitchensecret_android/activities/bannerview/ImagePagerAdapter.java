...
import com.meetyouatnowhere.kitchensecret_android.activities.favorActivity;
...
public class ImagePagerAdapter extends BaseAdapter {
	...
	public ImagePagerAdapter(Context context, List<String> imageIdList,
		...
		options = new DisplayImageOptions.Builder()
				...
				.showImageForEmptyUri(R.mipmap.meinv) // 设置图片Uri为空或是错误的时候显示的图片
				.showImageOnFail(R.mipmap.meinv) // 设置图片加载或解码过程中发生错误显示的图片
