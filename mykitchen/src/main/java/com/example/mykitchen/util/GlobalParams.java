...
//	public static final String MAIN_URL = "http://5.196.19.84:1337/json";
    ...
    public static final String TAG_GOBAL_SHARE_PREFERENCES = "connection_preferences";

    public static final String TAG_LOGIN_PREFERENCES = "connection_user_login";

    public static final String TAG_NOTIFICATION_PREFERENCES = "connection_notification_num";
