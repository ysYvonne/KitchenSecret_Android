...
import com.example.mykitchen.adapter.RecipeAdapter;
 ...
 */
public class RecipeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == LoginActivity.KEY_IS_LOGIN) {
            isLogin = true;
        } else if (resultCode == RecipeAddActivity.KEY_ADD_DISH) {
            isRefresh = true;
            getAllRecipees();
        }
    }
